(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=t(a);fetch(a.href,n)}})();class H{constructor(){this.routes=new Map,this.currentPage=null,this.currentParams={},this.history=[],window.addEventListener("popstate",e=>{this.handleRoute(window.location.pathname,!1)})}register(e,t){return this.routes.set(e,t),this}navigate(e,t={}){this.history.push({path:window.location.pathname,state:this.currentParams}),window.history.pushState(t,"",e),this.handleRoute(e,!0)}back(){this.history.length>0?window.history.back():this.navigate("/")}handleRoute(e,t=!0){const{handler:s,params:a}=this.matchRoute(e);if(!s){console.warn(`路由未找到: ${e}`),e!=="/"&&this.navigate("/");return}this.currentParams=a;const n=document.getElementById("app");if(!n){console.error("找不到 #app 容器");return}const r=n.querySelector(".page");r&&r.classList.add(t?"page-exit":"page-exit-back"),setTimeout(()=>{let o;if(typeof s=="function")try{o=new s(a)}catch{o=s(a)}if(o&&typeof o.render=="function"){n.innerHTML=o.render();const l=n.querySelector(".page");l&&l.classList.add(t?"page-enter":"page-enter-back"),typeof o.attachEvents=="function"&&o.attachEvents(),typeof o.init=="function"&&o.init(),this.currentPage=o}else typeof o=="string"&&(n.innerHTML=o);window.scrollTo(0,0)},r?250:0)}matchRoute(e){if(this.routes.has(e))return{handler:this.routes.get(e),params:{}};for(const[t,s]of this.routes){const a=this.extractParams(t,e);if(a!==null)return{handler:s,params:a}}return{handler:null,params:{}}}extractParams(e,t){const s=e.split("/").filter(Boolean),a=t.split("/").filter(Boolean);if(s.length!==a.length)return null;const n={};for(let r=0;r<s.length;r++)if(s[r].startsWith(":")){const o=s[r].slice(1);n[o]=decodeURIComponent(a[r])}else if(s[r]!==a[r])return null;return n}getParams(){return this.currentParams}start(){this.handleRoute(window.location.pathname,!1)}}const w=new H;window.router=w;class q{constructor(){this.state={},this.listeners=new Map,this.storageKey="matching_game_state",this.loadFromStorage()}get(e,t=null){return e in this.state?this.state[e]:t}set(e,t,s=!1){const a=this.state[e];this.state[e]=t,this.listeners.has(e)&&this.listeners.get(e).forEach(n=>{n(t,a)}),s&&this.saveToStorage()}update(e,t,s=!1){const a=this.get(e,{});this.set(e,{...a,...t},s)}delete(e){delete this.state[e],this.saveToStorage()}subscribe(e,t){return this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t),()=>{this.listeners.get(e).delete(t)}}saveToStorage(){try{const e={user:this.state.user,testHistory:this.state.testHistory,settings:this.state.settings};localStorage.setItem(this.storageKey,JSON.stringify(e))}catch(e){console.warn("保存状态失败:",e)}}loadFromStorage(){try{const e=localStorage.getItem(this.storageKey);if(e){const t=JSON.parse(e);this.state={...this.state,...t}}}catch(e){console.warn("加载状态失败:",e)}}clear(){this.state={},localStorage.removeItem(this.storageKey)}}const S=new q;S.set("currentTest",null);S.set("testProgress",{step:0,total:0});window.appState=S;const R=[{id:"love",icon:"💑",title:"感情匹配",description:"测试你们的契合指数",longDescription:"通过生日特质或直觉卡牌分析，深入了解你与TA之间的性格契合度，探索两人性格的互补与摩擦点。",price:29.9,category:"relationship",popular:!0,features:["性格特质分析","性格互补性评估","相处建议"]},{id:"career",icon:"💼",title:"职场关系",description:"解析职场人际关系",longDescription:"分析你与同事、领导之间的相处之道，了解职场中的潜在助力与阻力。",price:29.9,category:"career",popular:!0,features:["领导关系分析","同事相处建议","职场风险提示"]},{id:"cooperation",icon:"🤝",title:"合作关系",description:"看清合作对象，早做决定",longDescription:"评估你与潜在合作伙伴的契合度，分析合作中可能遇到的挑战与机遇。",price:29.9,category:"career",popular:!1,features:["合作契合度评分","风险预警","合作策略建议"]},{id:"thoughts",icon:"💭",title:"TA的想法和态度",description:"揭开TA的真实想法",longDescription:"通过直觉卡牌测试，探索对方内心的真实想法和对你的态度。",price:29.9,category:"relationship",popular:!0,features:["对方心理分析","真实态度解读","沟通建议"]},{id:"job",icon:"📈",title:"职业发展",description:"找到最适合你的职业方向",longDescription:"基于你的性格特征分析，为你推荐最适合的职业发展方向。",price:29.9,category:"career",popular:!1,features:["性格职业匹配","行业推荐","发展路径规划"]},{id:"city",icon:"🗺️",title:"城市方向",description:"哪座城市最适合你发展",longDescription:"根据你的出生地和性格特征，分析最适合你发展的城市方向。",price:29.9,category:"direction",popular:!1,features:["方位适配分析","城市推荐","发展建议"]},{id:"peach",icon:"🌸",title:"社交魅力",description:"测试你的社交魅力值",longDescription:"分析你近期的社交状态，了解提升人际吸引力的方式。",price:29.9,category:"relationship",popular:!0,features:["社交魅力分析","提升建议","人际关系指导"]},{id:"benefactor",icon:"⭐",title:"人脉分析",description:"发现你身边的助力者",longDescription:"分析适合你的人脉特征，帮助你识别和拓展有价值的人际关系。",price:29.9,category:"direction",popular:!1,features:["人脉特征分析","识别方法","社交建议"]},{id:"yesno",icon:"❓",title:"Yes or No",description:"犹豫时，快速帮你判断",longDescription:"面对选择犹豫不决？让直觉卡牌给你一个参考答案。",price:19.9,category:"decision",popular:!0,features:["快速测试","明确答案","行动建议"]},{id:"choice",icon:"⚖️",title:"二选一",description:"左右为难？帮你稳妥选对",longDescription:"两个选择左右为难？直觉卡牌帮你分析每个选择的利弊。",price:19.9,category:"decision",popular:!1,features:["双选对比分析","利弊权衡","最优建议"]}];function x(i){return R.find(e=>e.id===i)}function y(i={}){const{title:e="匹配游戏",showBack:t=!1,showHistory:s=!1,showProfile:a=!0,onBack:n=null}=i;return`
  ...
  `}function O(i={}){const{icon:e="✨",title:t="发现你的性格契合度",subtitle:s="探索人际关系的奥秘",buttonText:a="开始测试",onButtonClick:n=null}=i;return`
  ...
  `}function P(i,e,t={}){const{showText:s=!0,showSteps:a=!1}=t,n=Math.min(i/e*100,100),r=a?`
    <div class="progress-bar__steps">
      ${Array.from({length:e},(l,c)=>`
        <div class="progress-bar__step ${c<i?"completed":""} ${c===i?"active":""}">
          ${c+1}
        </div>
      `).join("")}
    </div>
  `:"",o=s?`<div class="progress-bar__text">${i} / ${e}</div>`:"";return`
  ...
  `}function F(i,e={}){const{showPrice:t=!1,showBadge:s=!0,onClick:a=null}=e,n=s&&i.popular?'<span class="feature-card__badge">热门</span>':"",r=t?`<span class="feature-card__price">¥${i.price}</span>`:"";return`
  ...
  `}class j{constructor(){this.matchTypes=R}render(){return`
      <div class="page home-page">
        ${y({title:"匹配游戏",showBack:!1,showHistory:!1,showProfile:!0})}
        
        <main class="page-content">
          <div class="app-container">
            
            <!-- 欢迎横幅 -->
            ${O({icon:"✨",title:"发现你的性格契合度",subtitle:"探索人际关系的奥秘",buttonText:"开始匹配..."})}
    ...
    `:""}attachEvents(){const e=document.querySelector(".navbar__back-btn");e&&e.addEventListener("click",()=>{window.router.back()}),document.querySelectorAll(".method-card").forEach(t=>{t.addEventListener("click",()=>{const s=t.dataset.method;this.handleMethodSelect(s)})})}handleMethodSelect(e){const t=this.matchType.id;e==="birthday"?window.router.navigate(`/test/${t}/birthday`):e==="tarot"&&window.router.navigate(`/test/${t}/tarot`)}}const _=[19416,19168,42352,21717,53856,55632,91476,22176,39632,21970,19168,42422,42192,53840,119381,46400,54944,44450,38320,84343,18800,42160,46261,27216,27968,109396,11104,38256,21234,18800,25958,54432,59984,28309,23248,11104,100067,37600,116951,51536,54432,120998,46416,22176,107956,9680,37584,53938,43344,46423,27808,46416,86869,19872,42416,83315,21168,43432,59728,27296,44710,43856,19296,43748,42352,21088,62051,55632,23383,22176,38608,19925,19152,42192,54484,53840,54616,46400,46752,103846,38320,18864,43380,42160,45690,27216,27968,44870,43872,38256,19189,18800,25776,29859,59984,27480,23232,43872,38613,37600,51552,55636,54432,55888,30034,22176,43959,9680,37584,51893,43344,46240,47780,44368,21977,19360,42416,86390,21168,43312,31060,27296,44368,23378,19296,42726,42208,53856,60005,54576,23200,30371,38608,19195,19152,42192,118966,53840,54560,56645,46496,22224,21938,18864,42359,42160,43600,111189,27936,44448,84835,37744,18936,18800,25776,92326,59984,27424,108228,43744,41696,53987,51552,54615,54432,55888,23893,22176,42704,21972,21200,43448,43344,46240,46758,44368,21920,43940,42416,21168,45683,26928,29495,27296,44368,84821,19296,42352,21732,53600,59752,54560,55968,92838,22224,19168,43476,41680,53584,62034,54560],D=["正","二","三","四","五","六","七","八","九","十","冬","腊"],A=["初一","初二","初三","初四","初五","初六","初七","初八","初九","初十","十一","十二","十三","十四","十五","十六","十七","十八","十九","二十","廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"],U=["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"],J=["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"],W=["鼠","牛","虎","兔","龙","蛇","马","羊","猴","鸡","狗","猪"];function Y(i){let e=348;for(let t=32768;t>8;t>>=1)e+=_[i-1900]&t?1:0;return e+L(i)}function L(i){return M(i)?_[i-1900]&65536?30:29:0}function M(i){return _[i-1900]&15}function V(i,e){return _[i-1900]&65536>>e?30:29}function K(i,e,t){if(i<1900||i>2100)return null;const s=new Date(1900,0,31),a=new Date(i,e-1,t);let n=Math.floor((a-s)/864e5),r=1900,o=0;for(r=1900;r<2101&&n>0;r++)o=Y(r),n-=o;n<0&&(n+=o,r--);const l=M(r);let c=!1,d=1;for(d=1;d<13&&n>0;d++)l>0&&d===l+1&&!c?(--d,c=!0,o=L(r)):o=V(r,d),c&&d===l+1&&(c=!1),n-=o;n===0&&l>0&&d===l+1&&(c?c=!1:(c=!0,--d)),n<0&&(n+=o,--d);const m=n+1,$=U[(r-4)%10]+J[(r-4)%12],h=W[(r-4)%12];return{lunarYear:r,lunarMonth:d,lunarDay:m,isLeap:c,ganzhiYear:$,animal:h,yearStr:`${r}年`,monthStr:`${c?"闰":""}${D[d-1]}月`,dayStr:A[m-1],fullStr:`农历${r}年 ${$}年（${h}年） ${c?"闰":""}${D[d-1]}月${A[m-1]}`}}function Q(i){if(!i)return"";const[e,t,s]=i.split("-").map(Number),a=K(e,t,s);return a?a.fullStr:"日期超出范围"}class Z{constructor(e){if(this.matchType=x(e.type),!this.matchType){window.router.navigate("/");return}this.formData={personA:{name:"",gender:"",birthDate:""},personB:{name:"",gender:"",birthDate:""}},this.currentStep=1}render(){return this.matchType?`
      <div class="page birthday-input-page">
        ${y({title:"生日匹配",showBack:!0,showHistory:!1,showProfile:!1})}
        ...
        <main class="page-content">
          <div class="app-container">
            ...
            <section class="progress-section mt-4 mb-6">
              ${P(this.currentStep,2,{showText:!1,showSteps:!0})}
    ...
    `:""}renderPersonAInfo(){const{name:e,gender:t,birthDate:s}=this.formData.personA;return`
      <section class="person-a-info mt-4 animate-fade-in">
        <div class="glass-card glass-card--light glass-card--compact">
          <div class="flex items-center gap-3">
            <span class="person-avatar">${t==="male"?"👨":"👩"}</span>
            <div>
              <p class="body-text">${e||"你"}</p>
    ...
    `}attachEvents(){const e=document.querySelector(".navbar__back-btn");e&&e.addEventListener("click",()=>{this.currentStep===2?this.goBackStep():window.router.back()}),document.querySelectorAll(".gender-btn").forEach(o=>{o.addEventListener("click",()=>{this.selectGender(o.dataset.gender)})});const t=document.getElementById("name"),s=document.getElementById("birthDate"),a=document.getElementById("date-input-wrapper");t&&t.addEventListener("input",()=>this.validateForm()),s&&s.addEventListener("change",()=>{this.updateLunarDate(s.value),this.validateForm()}),a&&a.addEventListener("click",()=>{s?.showPicker?.(),s?.focus()});const n=document.querySelector('[data-action="next"]');n&&n.addEventListener("click",()=>this.handleNext());const r=document.querySelector('[data-action="back-step"]');r&&r.addEventListener("click",()=>this.goBackStep())}selectGender(e){document.querySelectorAll(".gender-btn").forEach(t=>{t.classList.toggle("active",t.dataset.gender===e)}),this.currentStep===1?this.formData.personA.gender=e:this.formData.personB.gender=e,this.validateForm()}validateForm(){const e=document.getElementById("name")?.value.trim(),t=document.getElementById("birthDate")?.value,s=this.currentStep===1?this.formData.personA.gender:this.formData.personB.gender,a=e&&t&&s,n=document.querySelector('[data-action="next"]');return n&&(n.disabled=!a),a}updateLunarDate(e){const t=document.getElementById("lunar-date"),s=t?.querySelector(".lunar-text");if(!(!t||!s))if(e){const a=Q(e);s.textContent=`农历：${a}`,t.style.display="flex"}else t.style.display="none"}handleNext(){if(!this.validateForm())return;const e=document.getElementById("name").value.trim(),t=document.getElementById("birthDate").value;this.currentStep===1?(this.formData.personA.name=e,this.formData.personA.birthDate=t,this.currentStep=2,this.rerender()):(this.formData.personB.name=e,this.formData.personB.birthDate=t,this.submitTest())}goBackStep(){this.currentStep===2&&(this.currentStep=1,this.rerender())}rerender(){const e=document.getElementById("app");e.innerHTML=this.render(),this.attachEvents(),this.currentStep===1&&this.formData.personA.name&&(document.getElementById("name").value=this.formData.personA.name,document.getElementById("birthDate").value=this.formData.personA.birthDate,this.formData.personA.gender&&this.selectGender(this.formData.personA.gender),this.formData.personA.birthDate&&this.updateLunarDate(this.formData.personA.birthDate))}submitTest(){window.appState.set("currentTest",{type:this.matchType.id,method:"birthday",personA:{name:this.formData.personA.name,gender:this.formData.personA.gender==="male"?"男":"女",birthDate:this.formData.personA.birthDate},personB:{name:this.formData.personB.name,gender:this.formData.personB.gender==="male"?"男":"女",birthDate:this.formData.personB.birthDate},timestamp:Date.now()}),window.router.navigate("/result/birthday")}}const X=[{id:0,name:"愚者",symbol:"🃏",upright:"新的开始、冒险精神、纯真",reversed:"冲动、缺乏计划",element:"风"},{id:1,name:"魔术师",symbol:"🎩",upright:"创造力、自信、技能",reversed:"缺乏方向、能力受限",element:"风"},{id:2,name:"女祭司",symbol:"🌙",upright:"直觉、智慧、内在洞察",reversed:"忽视直觉、信息不足",element:"水"},{id:3,name:"皇后",symbol:"👑",upright:"丰饶、关爱、创造力",reversed:"过度依赖、创造力受阻",element:"土"},{id:4,name:"皇帝",symbol:"🏛️",upright:"权威、稳定、领导力",reversed:"过于控制、缺乏灵活",element:"火"},{id:5,name:"教皇",symbol:"📿",upright:"传统、指导、精神追求",reversed:"思想僵化、缺乏创新",element:"土"},{id:6,name:"恋人",symbol:"💕",upright:"爱情、和谐、选择",reversed:"关系失衡、选择困难",element:"风"},{id:7,name:"战车",symbol:"🏇",upright:"胜利、决心、行动力",reversed:"方向不明、缺乏控制",element:"水"},{id:8,name:"力量",symbol:"🦁",upright:"内在力量、勇气、耐心",reversed:"自我怀疑、缺乏信心",element:"火"},{id:9,name:"隐士",symbol:"🏔️",upright:"内省、寻求智慧、独处",reversed:"孤立、过度封闭",element:"土"},{id:10,name:"机遇之轮",symbol:"🎡",upright:"转变、机遇、新阶段",reversed:"逆境、抗拒改变",element:"火"},{id:11,name:"正义",symbol:"⚖️",upright:"公平、真相、因果",reversed:"不公、逃避责任",element:"风"},{id:12,name:"倒吊人",symbol:"🙃",upright:"新视角、牺牲、等待",reversed:"拖延、无谓牺牲",element:"水"},{id:13,name:"死神",symbol:"🦋",upright:"转变、结束与新生",reversed:"抗拒改变、停滞",element:"水"},{id:14,name:"节制",symbol:"🏺",upright:"平衡、耐心、调和",reversed:"失衡、过度",element:"火"},{id:15,name:"恶魔",symbol:"🔗",upright:"束缚、欲望、物质",reversed:"解脱、摆脱限制",element:"土"},{id:16,name:"塔",symbol:"🗼",upright:"突变、觉醒、重建",reversed:"逃避改变、延迟",element:"火"},{id:17,name:"星星",symbol:"⭐",upright:"希望、灵感、平静",reversed:"失望、缺乏信心",element:"风"},{id:18,name:"月亮",symbol:"🌙",upright:"直觉、潜意识、情绪",reversed:"困惑、恐惧",element:"水"},{id:19,name:"太阳",symbol:"☀️",upright:"快乐、成功、活力",reversed:"暂时受阻、过度乐观",element:"火"},{id:20,name:"审判",symbol:"📯",upright:"觉醒、评估、新阶段",reversed:"自我批判、拒绝改变",element:"火"},{id:21,name:"世界",symbol:"🌍",upright:"完成、整合、成就",reversed:"未完成、缺乏闭合",element:"土"}];function ee(i){return i>=5?{type:"very_positive",name:"强正向能量",symbol:"☀️",description:"整体能量非常积极正面",score:85+Math.floor(Math.random()*10)}:i>=4?{type:"positive",name:"正向能量",symbol:"⭐",description:"整体趋势积极向好",score:70+Math.floor(Math.random()*15)}:i>=3?{type:"balanced",name:"平衡能量",symbol:"⚖️",description:"需要双方共同努力",score:55+Math.floor(Math.random()*15)}:i>=2?{type:"challenging",name:"挑战能量",symbol:"🌙",description:"存在一些需要面对的挑战",score:40+Math.floor(Math.random()*15)}:{type:"reflective",name:"反思能量",symbol:"🌑",description:"建议暂时观望，内省调整",score:25+Math.floor(Math.random()*15)}}function te(i=[]){const e=X.filter(n=>!i.includes(n.id)),t=Math.floor(Math.random()*e.length),s=e[t],a=Math.random()>.5;return{...s,isUpright:a,meaning:a?s.upright:s.reversed,position:a?"正位":"逆位"}}function se(i=6){const e=[],t=[];for(let s=0;s<i;s++){const a=te(e);e.push(a.id),t.push(a)}return t}function ae(i,e){const t=i.filter(n=>n.isUpright).length,s=ee(t),a={love:ne(i,s),career:ie(i,s),cooperation:re(i,s),thoughts:oe(i,s),job:ce(i,s),city:le(i,s),peach:de(i,s),benefactor:pe(i,s),yesno:ue(i,s),choice:he(i,s)};return{cards:i,energy:s,reading:a[e]||me(i,s),score:s.score,disclaimer:"本测试结果仅供娱乐参考，不构成任何专业建议。请理性看待测试结果。"}}function ne(i,e){return{very_positive:"双方性格特质显示出高度的契合与互补，建议珍惜这份默契，通过良好沟通进一步增进了解。",positive:"整体契合度良好，双方在某些方面存在互补优势。建议保持开放的心态，多创造共同话题。",balanced:"双方需要更多的理解与磨合。建议增加沟通频率，尊重彼此的差异性。",challenging:"存在一些性格差异需要面对。建议放慢节奏，先从朋友的角度相互了解。",reflective:"当前可能不是最佳时机，建议先专注于自我提升，给彼此一些空间和时间。"}[e.type]}function ie(i,e){return{very_positive:"职场人际关系处于良好状态，团队协作顺利。建议继续保持积极主动的工作态度。",positive:"与同事/领导的关系整体和谐，存在良好的合作基础。建议适时表达自己的想法。",balanced:"职场关系需要更多经营。建议主动沟通，明确各自的职责和期望。",challenging:"可能存在一些沟通障碍。建议换位思考，避免不必要的误解。",reflective:"建议暂时观察，调整自己的工作方式，寻找更合适的切入点。"}[e.type]}function re(i,e){return{very_positive:"合作前景看好，双方目标一致且互有优势。建议明确分工，发挥各自所长。",positive:"合作基础良好，但需要建立清晰的规则。建议签订书面协议，明确权责。",balanced:"合作需要更多磨合。建议先进行小规模试点，再决定是否深入合作。",challenging:"存在一些潜在风险。建议充分调研，做好风险评估后再做决定。",reflective:"当前时机可能不够成熟。建议暂缓决定，继续观察和收集信息。"}[e.type]}function oe(i,e){return{very_positive:"对方对你持有积极正面的印象，对你的关注度较高。建议主动创造交流机会。",positive:"对方对你有一定好感，但可能还在观察阶段。建议保持自然，展现真实的自己。",balanced:"对方的态度比较中立，需要更多互动来加深印象。建议找到共同话题。",challenging:"对方可能有一些顾虑或保留。建议给对方一些时间和空间。",reflective:"对方当前可能有其他关注的事情。建议暂时减少期待，专注于自我成长。"}[e.type]}function ce(i,e){return{very_positive:"职业发展前景乐观，当前方向正确。建议继续精进专业技能，把握机会。",positive:"职业道路整体顺利，有上升空间。建议拓展人脉，增加曝光度。",balanced:"职业发展需要更明确的规划。建议设定阶段性目标，稳步前进。",challenging:"可能遇到一些瓶颈。建议学习新技能，寻找突破点。",reflective:"建议暂停下来思考真正想要的方向，必要时可以寻求职业咨询。"}[e.type]}function le(i,e){return{very_positive:"所选方向非常适合你的发展，建议积极准备，把握机会。",positive:"整体方向不错，有发展潜力。建议做好调研，了解当地情况。",balanced:"各有利弊，需要综合考量。建议列出优缺点，根据自身情况决定。",challenging:"可能存在一些适应挑战。建议先短期尝试，再做长期决定。",reflective:"当前可能不是最佳时机。建议暂缓决定，继续收集信息。"}[e.type]}function de(i,e){return{very_positive:"社交魅力值很高，人际吸引力强。建议多参加社交活动，展现自我。",positive:"社交状态良好，有不错的人缘。建议保持真诚，拓展社交圈。",balanced:"社交能力需要提升。建议主动学习社交技巧，增加互动。",challenging:"可能有些社交压力。建议放松心态，从小范围社交开始。",reflective:"建议暂时关注内在修养，提升自信后再拓展社交。"}[e.type]}function pe(i,e){return{very_positive:"身边有潜在的助力者，建议留意那些愿意给你建议的人。",positive:"有获得帮助的机会，建议主动寻求指导，虚心请教。",balanced:"需要自己主动出击。建议扩大社交圈，建立有价值的人脉关系。",challenging:"当前主要依靠自己。建议提升自身能力，吸引志同道合的人。",reflective:"建议先专注于自我成长，好的人脉关系自然会到来。"}[e.type]}function ue(i,e){return{very_positive:"从测试结果看，可以积极行动，但仍需做好充分准备。",positive:"整体倾向积极，建议在做好规划后行动。",balanced:"需要更多信息才能做出判断。建议收集更多资料后再决定。",challenging:"建议暂缓行动，等待更好的时机。",reflective:"当前不建议仓促决定，给自己更多思考时间。"}[e.type]}function he(i,e){return{very_positive:"两个选择都有其优势，建议选择更符合长期目标的选项。",positive:"其中一个选择略占优势，建议综合考虑后做决定。",balanced:"两个选择各有利弊，建议列出详细对比，理性分析。",challenging:"两个选择都存在挑战，建议寻找第三种可能。",reflective:"建议暂时不做选择，给自己更多时间考虑。"}[e.type]}function me(i,e){return e.description+"建议保持开放的心态，理性看待测试结果。"}class ge{constructor(e){if(this.matchType=x(e.type),!this.matchType){window.router.navigate("/");return}this.currentRound=0,this.totalRounds=3,this.cardsPerRound=6,this.selectCount=3,this.results=[],this.isFlipping=!1,this.cardStates=new Array(this.cardsPerRound).fill(!1),this.currentCards=[],this.selectedCards=[],this.allSelectedCards=[],this.initRoundCards()}initRoundCards(){this.allSelectedCards.map(e=>e.id),this.currentCards=se(this.cardsPerRound),this.cardStates=new Array(this.cardsPerRound).fill(!1),this.selectedCards=[]}render(){return this.matchType?`
      <div class="page tarot-page">
        ${y({title:"直觉卡牌测试",showBack:!0,showHistory:!1,showProfile:!1})}
        ...
        <main class="page-content">
          <div class="app-container">
            ...
            <section class="progress-section mt-4 mb-4">
              ${P(this.currentRound,this.totalRounds,{showText:!0})}
            </section>
    ...
    `}attachEvents(){const e=document.querySelector(".navbar__back-btn");e&&e.addEventListener("click",()=>{this.currentRound>0||this.allSelectedCards.length>0?confirm("确定要退出吗？当前进度将丢失。")&&window.router.back():window.router.back()}),document.querySelectorAll(".flip-card-wrapper").forEach(s=>{s.addEventListener("click",()=>{const a=parseInt(s.dataset.cardIndex);this.flipCard(a)})});const t=document.querySelector('[data-action="next-round"]');t&&t.addEventListener("click",()=>{this.handleNextRound()})}flipCard(e){const t=this.cardStates.filter(n=>n).length;if(this.cardStates[e]||this.isFlipping||t>=this.selectCount)return;this.isFlipping=!0,this.cardStates[e]=!0;const s=document.querySelector(`[data-card-index="${e}"]`),a=s.querySelector(".flip-card");a.classList.add("flipped"),s.classList.add("selected"),this.selectedCards.push(this.currentCards[e]),setTimeout(()=>{const n=this.currentCards[e],r=a.querySelector(".flip-card__result"),o=a.querySelector(".flip-card__name"),l=a.querySelector(".flip-card__label");r.textContent=n.symbol,o.textContent=n.name,l.textContent=n.position,l.classList.add(n.isUpright?"upright":"reversed"),this.isFlipping=!1;const c=document.getElementById("card-hint");c&&(c.textContent=this.getCardHint()),this.updateBottomBar(),this.cardStates.filter(m=>m).length>=this.selectCount&&this.completeRound()},300)}updateBottomBar(){const e=document.querySelector(".bottom-action-bar");if(e){const t=this.cardStates.filter(a=>a).length;if(t>=this.selectCount){const a=this.currentRound>=this.totalRounds-1;e.innerHTML=`
        ...
        `}}completeRound(){this.allSelectedCards.push(...this.selectedCards),this.results.push({round:this.currentRound+1,cards:[...this.selectedCards]}),this.updateBottomBar()}handleNextRound(){this.currentRound<this.totalRounds-1?(this.currentRound++,this.initRoundCards(),this.rerender()):this.completeTest()}rerender(){const e=document.getElementById("app");e.innerHTML=this.render(),this.attachEvents()}completeTest(){const e=ae(this.allSelectedCards,this.matchType.id);window.appState.set("currentTest",{type:this.matchType.id,method:"tarot",results:this.results,allCards:this.allSelectedCards,reading:e,timestamp:Date.now()}),window.router.navigate("/result/tarot")}}const v=[{index:0,name:"甲",element:"木",nature:"阳",color:"#4CAF50"},{index:1,name:"乙",element:"木",nature:"阴",color:"#8BC34A"},{index:2,name:"丙",element:"火",nature:"阳",color:"#F44336"},{index:3,name:"丁",element:"火",nature:"阴",color:"#E91E63"},{index:4,name:"戊",element:"土",nature:"阳",color:"#795548"},{index:5,name:"己",element:"土",nature:"阴",color:"#A1887F"},{index:6,name:"庚",element:"金",nature:"阳",color:"#FFD700"},{index:7,name:"辛",element:"金",nature:"阴",color:"#FFC107"},{index:8,name:"壬",element:"水",nature:"阳",color:"#2196F3"},{index:9,name:"癸",element:"水",nature:"阴",color:"#03A9F4"}],f=[{index:0,name:"子",element:"水",nature:"阳",animal:"鼠"},{index:1,name:"丑",element:"土",nature:"阴",animal:"牛"},{index:2,name:"寅",element:"木",nature:"阳",animal:"虎"},{index:3,name:"卯",element:"木",nature:"阴",animal:"兔"},{index:4,name:"辰",element:"土",nature:"阳",animal:"龙"},{index:5,name:"巳",element:"火",nature:"阴",animal:"蛇"},{index:6,name:"午",element:"火",nature:"阳",animal:"马"},{index:7,name:"未",element:"土",nature:"阴",animal:"羊"},{index:8,name:"申",element:"金",nature:"阳",animal:"猴"},{index:9,name:"酉",element:"金",nature:"阴",animal:"鸡"},{index:10,name:"戌",element:"土",nature:"阳",animal:"狗"},{index:11,name:"亥",element:"水",nature:"阴",animal:"猪"}],b={木:{generates:"火",overcomes:"土",generatedBy:"水",overcomedBy:"金",color:"#4CAF50",emoji:"🌳"},火:{generates:"土",overcomes:"金",generatedBy:"木",overcomedBy:"水",color:"#F44336",emoji:"🔥"},土:{generates:"金",overcomes:"水",generatedBy:"火",overcomedBy:"木",color:"#795548",emoji:"🏔️"},金:{generates:"水",overcomes:"木",generatedBy:"土",overcomedBy:"火",color:"#FFD700",emoji:"🔶"},水:{generates:"木",overcomes:"火",generatedBy:"金",overcomedBy:"土",color:"#2196F3",emoji:"💧"}},C=[{name:"立春",month:1,day:4},{name:"惊蛰",month:2,day:6},{name:"清明",month:3,day:5},{name:"立夏",month:4,day:6},{name:"芒种",month:5,day:6},{name:"小暑",month:6,day:7},{name:"立秋",month:7,day:8},{name:"白露",month:8,day:8},{name:"寒露",month:9,day:9},{name:"立冬",month:10,day:8},{name:"大雪",month:11,day:7},{name:"小寒",month:12,day:6}];function ve(i,e,t){const s=C[0];(e<s.month+1||e===s.month+1&&t<s.day)&&(i-=1);const a=(i-4)%10,n=(i-4)%12;return{tiangan:v[a],dizhi:f[n],ganzhi:v[a].name+f[n].name}}function fe(i,e,t){let s=e-1;for(let c=C.length-1;c>=0;c--){const d=C[c];if(e>d.month+1||e===d.month+1&&t>=d.day){s=c;break}}s===11&&e===1&&(i-=1);const a=(i-4)%10,o=([2,4,6,8,0][a%5]+s)%10,l=(s+2)%12;return{tiangan:v[o],dizhi:f[l],ganzhi:v[o].name+f[l].name}}function ye(i,e,t){const s=new Date(1900,0,31),n=new Date(i,e-1,t).getTime()-s.getTime(),r=Math.floor(n/(1e3*60*60*24)),o=(r%10+10)%10,l=(r%12+12)%12;return{tiangan:v[o],dizhi:f[l],ganzhi:v[o].name+f[l].name}}function k(i){const e=new Date(i),t=e.getFullYear(),s=e.getMonth()+1,a=e.getDate(),n=ve(t,s,a),r=fe(t,s,a),o=ye(t,s,a);return{year:n,month:r,day:o,fullName:`${n.ganzhi} ${r.ganzhi} ${o.ganzhi}`,elements:be(n,r,o)}}function be(i,e,t){const s={金:0,木:0,水:0,火:0,土:0};[i,e,t].forEach(r=>{s[r.tiangan.element]+=1,s[r.dizhi.element]+=1});let a={element:"",count:0},n={element:"",count:1/0};return Object.entries(s).forEach(([r,o])=>{o>a.count&&(a={element:r,count:o}),o<n.count&&(n={element:r,count:o})}),{distribution:s,strongest:a,weakest:n,yongshen:n.element}}function xe(i,e){const t={score:0,details:[],conclusion:""};$e(i.day.tiangan.name,e.day.tiangan.name).isHe&&(t.score+=10,t.details.push({type:"positive",title:"日干相合",description:`${i.day.tiangan.name}${e.day.tiangan.name}相合，性格特质高度契合`})),we(i.year.dizhi.name,e.year.dizhi.name).isLiuhe&&(t.score+=8,t.details.push({type:"positive",title:"年支六合",description:`${i.year.dizhi.name}${e.year.dizhi.name}六合，家庭背景融洽`}));const n=Se(i.elements,e.elements);t.score+=n.score,t.details.push(...n.details);const r=_e(i,e);return t.score-=r.penalty,t.details.push(...r.details),t.score=Math.max(0,Math.min(100,t.score+50)),t.conclusion=Be(t.score,t.details),t}function $e(i,e){const t={甲己:"土",己甲:"土",乙庚:"金",庚乙:"金",丙辛:"水",辛丙:"水",丁壬:"木",壬丁:"木",戊癸:"火",癸戊:"火"},s=i+e;return{isHe:s in t,element:t[s]||null}}function we(i,e){const t={子丑:"土",丑子:"土",寅亥:"木",亥寅:"木",卯戌:"火",戌卯:"火",辰酉:"金",酉辰:"金",巳申:"水",申巳:"水",午未:"土",未午:"土"},s=i+e;return{isLiuhe:s in t,element:t[s]||null}}function Se(i,e){const t={score:0,details:[]},s=i.weakest.element,a=e.weakest.element,n=i.strongest.element,r=e.strongest.element;return s===r&&(t.score+=8,t.details.push({type:"positive",title:"五行互补",description:`对方${b[r].emoji}${r}可以弥补你${b[s].emoji}${s}的不足`})),a===n&&(t.score+=8,t.details.push({type:"positive",title:"五行互补",description:`你的${b[n].emoji}${n}可以弥补对方${b[a].emoji}${a}的不足`})),t}function _e(i,e){const t={penalty:0,details:[]},s=["子午","丑未","寅申","卯酉","辰戌","巳亥"];return[{pillarsA:i.year,pillarsB:e.year,name:"年柱"},{pillarsA:i.day,pillarsB:e.day,name:"日柱"}].forEach(({pillarsA:n,pillarsB:r,name:o})=>{const l=n.dizhi.name+r.dizhi.name,c=r.dizhi.name+n.dizhi.name;(s.includes(l)||s.includes(c))&&(t.penalty+=5,t.details.push({type:"negative",title:`${o}相冲`,description:`${n.dizhi.name}${r.dizhi.name}相冲，可能会有意见分歧`}))}),t}function Be(i,e){const t=e.filter(a=>a.type==="positive").length,s=e.filter(a=>a.type==="negative").length;return i>=80?"A和B互利：双方性格特质高度契合，非常适合建立良好关系。":i>=60?t>s?"A利B，B不利A：你在这段关系中付出较多，但整体是积极的。":"A不利B，B利A：对方在这段关系中获益更多。":i>=40?"A和B相互不利：双方性格有一定差异，需要更多包容和理解。":"A和B相互不利：分析显示双方差异较大，建议谨慎考虑。"}function Ce(i,e,t=50){return new Promise(s=>{let a=0;i.textContent="";const n=setInterval(()=>{a<e.length?(i.textContent+=e.charAt(a),a++):(clearInterval(n),s())},t)})}const z="http://43.143.84.132:3000/api";async function u(i,e={}){const t=`${z}${i}`,s={"Content-Type":"application/json"},a=localStorage.getItem("auth_token");a&&(s.Authorization=`Bearer ${a}`);const n={...e,headers:{...s,...e.headers}};try{const r=await fetch(t,n),o=await r.json();if(!r.ok)throw new g(o.error?.message||"请求失败",o.error?.code,r.status);return o}catch(r){throw r instanceof g?r:new g("网络连接失败，请检查网络","NETWORK_ERROR",0)}}class g extends Error{constructor(e,t,s){super(e),this.code=t,this.status=s}}const Te={async birthday(i){return u("/analysis/birthday",{method:"POST",body:JSON.stringify(i)})},async birthMatchStream(i,{onChunk:e,onDone:t,onError:s,signal:a}){try{const n=await fetch(`${z}/analysis/birthMatch`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i),signal:a});if(!n.ok){const c=await n.json();throw new g(c.error?.message||"请求失败",c.error?.code,n.status)}const r=n.body.getReader(),o=new TextDecoder;let l="";for(;;){const{done:c,value:d}=await r.read();if(c)break;const $=o.decode(d,{stream:!0}).split(`

`).filter(h=>h.trim());for(const h of $)if(h.startsWith("data: ")){const T=h.slice(6);if(T==="[DONE]"){t?.(l);return}try{const p=JSON.parse(T);if(p.content&&(l+=p.content,e?.(p.content,l)),p.error)throw new g(p.error,"STREAM_ERROR",500)}catch(p){if(p instanceof g)throw p}}}t?.(l)}catch(n){throw s?.(n),n}},async hexagram(i){return u("/analysis/hexagram",{method:"POST",body:JSON.stringify(i)})},async getResult(i){return u(`/analysis/result/${i}`)}},B={async createOrder(i){return u("/payment/create-order",{method:"POST",body:JSON.stringify(i)})},async getOrderStatus(i){return u(`/payment/order/${i}`)},async simulatePay(i){return u("/payment/simulate-pay",{method:"POST",body:JSON.stringify({orderId:i})})},async redeem(i){return u("/payment/redeem",{method:"POST",body:JSON.stringify({redeemCode:i})})},async getOrders(){return u("/payment/orders")}};class De{constructor(e){if(this.method=e.id,this.testData=window.appState.get("currentTest"),!this.testData){window.router.navigate("/");return}this.matchType=x(this.testData.type),this.result=null,this.isAnalyzing=!0,this.streamContent="",this.useAiAnalysis=!0,this.isStreamComplete=!1,this.isInitialized=!1,this.abortController=null}render(){return`
      <div class="page result-page">
        ${y({title:"分析结果",showBack:!0,showHistory:!1,showProfile:!1})}
      ...
      <div class="elements-bar">
        ${Object.entries(e.distribution).map(([t,s])=>`
          <div class="element-item">
            <span class="element-emoji">${b[t].emoji}</span>
...
`+s.disclaimer};return}const{hexagram:e}=this.testData;if(!e){this.result={score:50,conclusion:"数据解析异常，请重新测试。",details:[],suggestion:"建议重新进行测试。"};return}const t=this.calculateHexagramScore(e);this.result={hexagram:e,score:t,conclusion:this.getHexagramConclusion(e,t),details:this.getHexagramDetails(e),suggestion:this.generateHexagramSuggestion(e)}}getTarotDetails(e){const t=[],s=e.filter(n=>n.isUpright),a=e.filter(n=>!n.isUpright);return s.length>0&&t.push({type:"positive",title:`正位牌 (${s.length}张)`,description:s.map(n=>`${n.name}：${n.upright}`).join("；")}),a.length>0&&t.push({type:a.length<=3?"positive":"negative",title:`逆位牌 (${a.length}张)`,description:a.map(n=>`${n.name}：${n.reversed}`).join("；")}),t}calculateHexagramScore(e){const t=["乾","坤","泰","同人","大有","谦","咸","恒","益","萃"],s=["否","讼","剥","困","蹇","睽","明夷"];let a=60;return t.includes(e.name)?a+=20:s.includes(e.name)&&(a-=15),e.hasChanging&&(a+=e.changingPositions.length<=2?5:-5),Math.max(20,Math.min(95,a))}getHexagramConclusion(e,t){return t>=75?`${e.name}符号显示双方关系积极向好，有互利共赢的趋势。`:t>=55?`${e.name}符号提示需要双方共同努力，关系可以改善。`:`${e.name}符号暗示当前时机不太适合，建议谨慎行事。`}getHexagramDetails(e){const t=[];return t.push({type:"positive",title:`${e.name}符号`,description:e.meaning}),e.upper&&e.lower&&t.push({type:"positive",title:"上下符号分析",description:`上符号${e.upper.name}（${e.upper.nature}），下符号${e.lower.name}（${e.lower.nature}）`}),e.hasChanging&&t.push({type:e.changingPositions.length<=2?"positive":"negative",title:"变化分析",description:`第${e.changingPositions.join("、")}轮为变化轮，表示事情会有变化`}),t}generateSuggestion(e){const{score:t,details:s}=e;s.filter(r=>r.type==="positive");const a=s.filter(r=>r.type==="negative");let n="";return t>=80?n="这是非常好的契合度！双方在性格特质上高度互补，建议珍惜这份关系，共同维护。注意保持沟通，互相理解和包容。":t>=60?(n="整体关系是积极的，但也存在一些需要注意的地方。",a.length>0&&(n+=`特别是${a[0].title}方面，需要双方多一些耐心和理解。`),n+="只要用心经营，这段关系会越来越好。"):t>=40?n="双方存在一定的差异，但并非不可调和。建议：1) 增加沟通频率；2) 尊重对方的差异；3) 寻找共同兴趣。如果双方都愿意付出努力，关系是可以改善的。":n="从性格分析角度看，双方确实存在较大的差异。建议在做重要决定前，多观察、多了解对方。如果是合作关系，建议寻找其他机会；如果是感情关系，请谨慎考虑。",n}generateHexagramSuggestion(e){return`${e.name}符号的核心含义是"${e.meaning}"。根据分析结果提示，当前最重要的是保持平和的心态，不要急于求成。遇事多思考，听从内心的指引。如果有变化，说明事情会有转机，保持耐心等待合适的时机。`}delay(e){return new Promise(t=>setTimeout(t,e))}async analyzeWithAi(){const{personA:e,personB:t}=this.testData;this.abortController=new AbortController;const s=["1","2","3"],a=["正在收集信息...","正在进行特质计算...","正在请求 AI 分析..."];for(let n=0;n<s.length;n++){await this.delay(600);const r=document.getElementById("analyzing-text");r&&(r.textContent=a[n]);const o=document.querySelector(`[data-step="${s[n]}"]`);o&&o.classList.add("active")}try{await Te.birthMatchStream({partyA:e,partyB:t},{onChunk:(n,r)=>{if(this.streamContent=r,this.isAnalyzing){this.isAnalyzing=!1;const o=document.querySelector('[data-step="4"]');o&&o.classList.add("active"),this.updateToResultView()}else{const o=document.getElementById("ai-stream-content");o&&(o.innerHTML=this.formatMarkdown(this.streamContent)+this.renderLoadingIndicator(),this.scrollToBottom())}},onDone:n=>{this.streamContent=n,this.isAnalyzing=!1,this.isStreamComplete=!0;const r=document.getElementById("ai-stream-content");r&&(r.innerHTML=this.formatMarkdown(this.streamContent)+this.renderCompleteIndicator(),this.scrollToBottom(),setTimeout(()=>{const o=document.getElementById("stream-complete-indicator");o&&(o.style.opacity="0",setTimeout(()=>o.remove(),300))},1e3)),this.rerender()},onError:n=>{if(n.name==="AbortError"){console.log("请求已取消");return}console.error("AI 分析失败:",n),this.streamContent="分析失败，请稍后重试！",this.isAnalyzing=!1,this.rerender()},signal:this.abortController.signal})}catch(n){if(n.name==="AbortError"){console.log("请求已取消");return}console.error("AI 分析失败:",n),this.streamContent="分析失败，请稍后重试。",this.isAnalyzing=!1,this.rerender()}}updateToResultView(){const e=document.getElementById("analysis-container");e&&(e.innerHTML=this.renderResult())}renderAiResult(){const{personA:e,personB:t}=this.testData;return`
    ...
    `}renderCompleteIndicator(){return`
      <div class="stream-complete-indicator" id="stream-complete-indicator">
        <span class="complete-icon">✅</span>
        <span class="complete-text">已完成</span>
      </div>
    `}scrollToBottom(){const e=document.getElementById("ai-stream-content");e&&(e.scrollTop=e.scrollHeight),window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"})}formatMarkdown(e){return e?this.splitIntoSections(e).map((s,a)=>{const n=this.formatSectionContent(s);return n.trim()?`
        <div class="analysis-block animate-fade-in-up" style="animation-delay: ${a*.1}s;">
          ${n}
        </div>
      `:""}).join(""):""}splitIntoSections(e){const t=[];let s="";const a=e.split(`
`);for(const n of a)/^##?#?\s/.test(n)||/^【[^】]+】/.test(n)||/^第[一二三四五六七八九十]+步/.test(n)||/^[\*\-]\s*第[一二三四五六七八九十]+步/.test(n)||/^[\*\-]\s*\*\*第[一二三四五六七八九十]+步/.test(n)||/^[\d]+\.\s*第[一二三四五六七八九十]+步/.test(n)||/^[\*\-]\s*\*\*[甲乙]方/.test(n)?(s.trim()&&t.push(s.trim()),s=n):(n.trim()===""&&s.trim(),s+=`
`+n);return s.trim()&&t.push(s.trim()),t.length<=1&&e.includes(`

`)?e.split(/\n\n+/).filter(n=>n.trim()):t.length>0?t:[e]}formatSectionContent(e){const t=a=>a.includes("第一步")||a.includes("坐标")||a.includes("确立")?"📍":a.includes("第二步")||a.includes("输出")||a.includes("判定")?"🔍":a.includes("第三步")||a.includes("打分")||a.includes("量化")?"⭐":a.includes("第四步")||a.includes("判词")||a.includes("结论")||a.includes("综合")?"🎯":a.includes("需求")||a.includes("用神")||a.includes("清单")?"📋":a.includes("资产")||a.includes("核定")?"💎":a.includes("评分")||a.includes("细则")?"⭐":a.includes("建议")||a.includes("提示")?"💡":a.includes("甲方")||a.includes("乙方")?"":"📌";let s=e.replace(/^[\*\-]?\s*\*?\*?第([一二三四五六七八九十]+)步[：:]\s*(.+)$/gm,(a,n,r)=>`<div class="block-header"><span class="block-icon">${t(`第${n}步`)}</span><span class="block-title">第${n}步：${r}</span></div>`).replace(/^[\*\-]?\s*\*?\*?([甲乙])方\*?\*?$/gm,(a,n)=>`<div class="person-header"><span class="person-emoji">${n==="甲"?"👨":"👩"}</span><span class="person-label">${n}方</span></div>`).replace(/^\[([^\]]+)\](?![\(\[])/gm,(a,n)=>`<div class="block-subheader"><span class="block-icon">${t(n)}</span><span class="block-subtitle">${n}</span></div>`).replace(/^【([^】]+)】/gm,(a,n)=>`<div class="block-header"><span class="block-icon">${t(n)}</span><span class="block-title">${n}</span></div>`).replace(/^###\s+(.+)$/gm,'<div class="block-header"><span class="block-icon">📌</span><span class="block-title">$1</span></div>').replace(/^##\s+(.+)$/gm,'<div class="block-header"><span class="block-icon">📋</span><span class="block-title">$1</span></div>').replace(/^#\s+(.+)$/gm,'<div class="block-header main-header"><span class="block-icon">📊</span><span class="block-title">$1</span></div>').replace(/^([一二三四五六七八九十]+)[、.]\s*(.+)$/gm,'<div class="block-subheader"><span class="block-num">$1</span><span class="block-subtitle">$2</span></div>').replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/^\*\s{3}(.+)$/gm,'<li class="sub-item">$1</li>').replace(/^[-*•]\s*(.+)$/gm,"<li>$1</li>").replace(/^(\d+)[.)、]\s*(.+)$/gm,'<li class="numbered"><span class="list-num">$1.</span> $2</li>').replace(/([^<>\n]+?)：([^<>\n]+)/g,'<span class="label-text">$1：</span><span class="value-text">$2</span>').replace(/\n/g,"<br>");return s=s.replace(/(<li[^>]*>.*?<\/li>)(<br>)?/g,"$1"),s=s.replace(/(<li[^>]*>.*?<\/li>)+/g,a=>'<ul class="block-list">'+a+"</ul>"),s=s.replace(/(<br>){3,}/g,"<br><br>"),s=s.replace(/^(<br>)+/,""),s=s.replace(/(<br>)+$/,""),s=this.convertToComparisonLayout(s),`<div class="block-content">${s}</div>`}convertToComparisonLayout(e){const t=/<strong>\d*\.?\s*(甲方|A方|A：|甲：)[^<]*<\/strong>([\s\S]*?)(?=<strong>\d*\.?\s*(乙方|B方|B：|乙：)|<h[345]|$)/gi,s=/<strong>\d*\.?\s*(乙方|B方|B：|乙：)[^<]*<\/strong>([\s\S]*?)(?=<strong>\d*\.?\s*(甲方|A方)|<h[345]|【|$)/gi,a=[...e.matchAll(t)],n=[...e.matchAll(s)];if(a.length>0&&n.length>0)for(let r=0;r<Math.min(a.length,n.length);r++){const o=a[r][0],l=n[r][0],c=`
          <div class="comparison-container">
            <div class="comparison-item comparison-left">
              <div class="comparison-label">👨 甲方</div>
              <div class="comparison-content">${this.cleanComparisonContent(o)}</div>
            </div>
            <div class="comparison-item comparison-right">
              <div class="comparison-label">👩 乙方</div>
              <div class="comparison-content">${this.cleanComparisonContent(l)}</div>
            </div>
          </div>
        `;e=e.replace(o,c),e=e.replace(l,"")}return e}cleanComparisonContent(e){return e.replace(/<strong>\d*\.?\s*(甲方|乙方|A方|B方|A：|B：|甲：|乙：)[^<]*<\/strong>/gi,"").replace(/^(<br>|\s)+/g,"").replace(/(<br>|\s)+$/g,"")}rerender(){const e=document.getElementById("app");e.innerHTML=this.render(),this.attachEvents()}handleShare(){const e=`我刚刚在匹配游戏进行了${this.matchType?.title}测试，匹配度${this.result?.score}%！快来试试吧~`;navigator.share?navigator.share({title:"匹配游戏 - 趣味性格测试",text:e,url:window.location.origin}):navigator.clipboard.writeText(e).then(()=>{window.showToast("链接已复制，快去分享吧！")})}}class Ae{constructor(e){this.testType=e.type,this.matchType=x(this.testType),this.orderId=null,this.paymentMethod="alipay",this.qrCodeData=null,this.redeemCode=null,this.status="selecting",this.pollingTimer=null}render(){return`
      <div class="page payment-page">
        ${y({title:"支付",showBack:!0,showHistory:!1,showProfile:!1})}
