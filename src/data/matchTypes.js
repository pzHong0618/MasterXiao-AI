...
export const matchTypes = [
    {
        ...
        longDescription: '通过生日特质或直觉卡牌分析，深入了解你与TA之间的性格契合度，探索两人性格的互补与摩擦点。',
        price: 29.9,
    ...
    },
    {
        ...
        longDescription: '通过直觉卡牌测试，探索对方内心的真实想法和对你的态度。',
        price: 29.9,
        category: 'relationship',
        popular: true,
    ...
    },
    {
        ...
        longDescription: '面对选择犹豫不决？让直觉卡牌给你一个参考答案。',
        price: 19.9,
        category: 'decision',
        popular: true,
    ...
    },
    {
        ...
        longDescription: '两个选择左右为难？直觉卡牌帮你分析每个选择的利弊。',
        price: 19.9,
        category: 'decision',
        popular: false,
